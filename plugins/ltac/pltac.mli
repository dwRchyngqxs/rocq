...
val constr_eval : (constr_expr, qualid or_by_notation, constr_expr, qualid or_by_notation, qualid or_by_notation * int Locus.or_var option, int Locus.or_var, Genarg.rlevel Redexpr.user_red_expr) may_eval Entry.t
